    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ route('index') }}"><img src="./assets/compiled/svg/logo.svg" alt="Logo"
                            srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ $type_menu === 'index' ? 'active' : '' }}">
                ...
                <li class="sidebar-item  has-sub {{ $type_menu === 'component' ? 'active' : '' }}">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item {{ Request::is('component-accordion') ? 'active' : '' }}">
                            <a href="{{ route('component-accordion') }}" class="submenu-link">Accordion</a>

                        </li>

                        <li class="submenu-item {{ Request::is('component-alert') ? 'active' : '' }}">
