            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Alert</h3>
                        <p class="text-subtitle text-muted">A pretty helpful component to show emphasized information to the
                            user.</p>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-success"><i class="bi bi-check-circle"></i> This is success alert.
                                </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-light-primary color-primary"><i class="bi bi-star"></i> This is
                                    primary
                                    alert.</div>
                                <div class="alert alert-light-success color-success"><i class="bi bi-check-circle"></i> This
                                    is
                                    success alert.</div>
                                ...
                                <div class="alert alert-light-danger color-danger"><i
                                    ...
                                    is danger alert.</div>
                                <div class="alert alert-light-secondary color-secondary"><i class="bi bi-star"></i> This
                                    is
                                    secondary alert.</div>
                                <div class="alert alert-light-info color-info"><i class="bi bi-star"></i> This is info
                                    alert.
                                </div>
                            </div>
                        </div>
